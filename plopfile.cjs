module.exports = function (plop) {
  plop.setGenerator("page", {
    ...
    actions: [
      ...
      {
        type: "add",
        path: "src/domain/{{kebabCase pageName}}/models/index.ts",
        templateFile: "src/infra/templates/domain/models/index.hbs",
      },
      {
        type: "add",
        path: "src/domain/{{kebabCase pageName}}/services/{{kebabCase pageName}}.useCases.ts",
        templateFile:
          "src/infra/templates/domain/services/service.useCases.hbs",
      },
      {
        type: "add",
        path: "src/domain/{{kebabCase pageName}}/index.ts",
